...
class TextAnimation {
    constructor(selector, selector2) {
        ...
        this.text = this.parentDiv.querySelector(selector2)
        
        this.textTypingAnimation()
    }
    
    textTypingAnimation() {
        let textContent = this.text.innerHTML
        this.text.innerHTML = ' ' 
        let i = 0
        let timer = setInterval(() => {
            this.text.innerHTML += textContent[i]
            i++
...
let textAnimation = new TextAnimation('.header__content', 'h1')
